...
final class ISO3166 implements \Countable, \IteratorAggregate, ISO3166DataProvider
{
    ...
    /** @var iterable<string> */
    private iterable $keys = [self::KEY_ALPHA2, self::KEY_ALPHA3, self::KEY_NUMERIC, self::KEY_NAME];
    ...
    /**
     * @param iterable<Country> $countries replace default dataset with given array
     */
    ...
    public function exactName(string $name): Country
    {
     ...
     *
     * @return \Generator<string, Country>
     */
